                                        ...
                                        <tbody>
                                            ...
                                            if ($result) {
                                                ...
                                                foreach($result as $row) {
                                                    echo "<tr>";
                                                    echo "<th> $index </th>";
                                                    echo "<td>" . $row['em_fname']. "</td>";
                                                    echo "<td>" . $row["em_lname"] . "</td>";
                                                    echo "<td>" . $row["em_birthday"] . "</td>";
                                                    ...
                                                    echo "<td>" . $row["acc_username"] . "</td>";
                                                    echo "<td style='text-align: center;'> <a href='edit-employee.php?id=".$row['em_id']."'><input id='btnSua' class='btn btn-success' type='button' value='Sửa' '> 
                                                    <a href='delete-employee.php?id=".$row['em_id']."'><input id='btnXoa' class='btn btn-warning' type='button' value='Xoá' '>
                                                    ";
                                                    echo "</tr>";
                                                    $index++;
                                                }
