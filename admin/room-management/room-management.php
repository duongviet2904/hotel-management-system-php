                                    ...
                                    <table class="mb-0 table">
                                        ...
                                        if ($query) {
                                            foreach ($query as $item) {
                                                ...
                                                echo " <td style='text-align: center;'> <a href='edit-room.php?id=" . $item['room_id'] . "'><input id='btnSua' type='button' class='btn btn-success' value='Sửa' '>";
                                                echo " <a href='delete-room.php?id=" . $item['room_id'] . "'><input id='btnXoa' type='button' class='btn btn-warning' value='Xoá' '></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
